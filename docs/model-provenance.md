...
| Проверка спорного OCR | Консервативный выбор только между двумя многокадровыми OCR-кандидатами | `microsoft/Florence-2-base-ft` | snapshot `f6c1a25888ffc1d945ee8a1a77ac833c7303d46e` (0,23B) | [официальный Microsoft repository](https://huggingface.co/microsoft/Florence-2-base-ft) | Тот же repository, закреплённый commit через `huggingface_hub.snapshot_download` | MIT | `models/florence-2-base-ft/model.safetensors`; Windows runtime `.venv-florence/` | Скачан 2026-07-22, не конвертирован, не изменён и не обучался в проекте. На Windows выполняется в отдельном CUDA 13 процессе; результат вне обычных OCR-кандидатов отбрасывается. SHA-256 `58757D657FF44051314C8030B68E04CB1BB618CA9A4885418F111F6FB708185A` |
